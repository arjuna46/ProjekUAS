...
Mengonfigurasi Nama Pengguna:
 ...
 - git remote add origin https://github.com/arjuna46/junaaa.git Remote Repository merupakan repository server yang akan digunakan untuk menyimpan setiap perubahan pada 
